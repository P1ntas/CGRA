...
export class MyTangram extends CGFobject {
  ...
  initMaterials(scene) {
    ...
    // light green
    this.square = new CGFappearance(this);
    this.square.setAmbient(0.1, 0.1, 0.1, 1.0);
    this.square.setDiffuse(144 / 255, 238 / 255, 144 / 255, 1.0);
    this.square.setSpecular(0.9, 0.9, 0.9, 1.0);
    this.square.setShininess(10.0);
    
    // orange
    this.rightTriangle = new CGFappearance(this);
    this.rightTriangle.setAmbient(0.1, 0.1, 0.1, 1.0);
    ...
    // light blue
    this.leftTriangle = new CGFappearance(this);
    this.leftTriangle.setAmbient(0.1, 0.1, 0.1, 1.0);
    this.leftTriangle.setDiffuse(173 / 255, 216 / 255, 230 / 255, 1.0);
    this.leftTriangle.setSpecular(0.9, 0.9, 0.9, 1.0);
    this.leftTriangle.setShininess(10.0);

    // pink
    this.invTriangle = new CGFappearance(this);
    this.invTriangle.setAmbient(0.1, 0.1, 0.1, 1.0);
    ...
    // yellow
    this.paral = new CGFappearance(this);
    this.paral.setAmbient(0.1, 0.1, 0.1, 1.0);
    this.paral.setDiffuse(1, 255, 0, 1.0);
    this.paral.setSpecular(0.9, 0.9, 0.9, 1.0);
    this.paral.setShininess(10.0);

    // red
    this.smalLeftTriangle = new CGFappearance(this);
    this.smalLeftTriangle.setAmbient(0.1, 0.1, 0.1, 1.0);
    this.smalLeftTriangle.setDiffuse(255, 0, 0, 1.0);
    this.smalLeftTriangle.setSpecular(0.9, 0.9, 0.9, 1.0);
    this.smalLeftTriangle.setShininess(10.0);

    // purple
    this.smalRightTriangle = new CGFappearance(this);
    this.smalRightTriangle.setAmbient(0.1, 0.1, 0.1, 1.0);
