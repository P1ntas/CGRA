...
export class MyTangram extends CGFobject {
  ...
  initMaterials(scene) {
    ...
    this.smalLeftTriangle.texCoords = []
    ...
    this.smalRightTriangle.texCoords = []
